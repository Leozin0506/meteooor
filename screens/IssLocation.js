...
import {Text, View, ImageBackground, Image, SafeAreaView, StyleSheet, StatusBar, Alert} from 'react-native';
        ...
        <ImageBackground source={require("../assets/iss_bg.png")} style={styles.backgroundImage}>
            <View style={styles.titleContainer}>
                <Text style={styles.titleText}>
                    Localização dos Meteoros
                </Text>
            </View>
            <View style={styles.mapContainer}>
                <MapView style={stles.map} region={{
